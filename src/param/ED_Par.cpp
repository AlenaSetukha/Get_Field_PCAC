...
//===============================================================================================
/**
 * ЭД параметры для диэлектрика. Две среды - внешняя и внутренняя.
               ...
               const double epr_phiStartIn, const double epr_phiEndIn)
{
    ...
    lambda[0] = lambda[0] / (real_radius * 1e-6 / program_radius);              // программное lambda
    ...
    lambda[1] = lambda[1] / (real_radius * 1e-6 / program_radius);              // программное lambda
...
ED_Par::ED_Par(const ED_Par &ed_obj) {
    ...
    e0[0] = ed_obj.e0[0], e0[1] = ed_obj.e0[1], e0[2] = ed_obj.e0[2]; 
